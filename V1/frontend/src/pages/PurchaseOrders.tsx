  ...
  return (
    <div className="space-y-6">
      ...
      {viewMode === "list" && (
        <>
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Purchase Orders (POs)</h1>
            <p className="text-sm text-muted-foreground mt-1">Manage and track issued purchase orders</p>
          </div>
